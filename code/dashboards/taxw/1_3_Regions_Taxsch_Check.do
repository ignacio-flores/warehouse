...
// Output: $intfile/taxw_USstates_taxsched_data.dta; taxw_USstates_sources.dta 
...
// Check for duplicates and save sources in a separate file
	preserve 
		...
		drop id
		save "$intfile/taxw_USstates_sources.dta", replace
	restore 
...
compress
save "$intfile/taxw_USstates_taxsched_data.dta", replace
}
