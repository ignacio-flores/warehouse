	...
	foreach var of local revs{
		...
		forvalues p=1/9{
			...
			replace `var'_round_backup = `var'_round_backup/(10^`p') if ///
										`var'_round_backup>(10^`p') & `var'_round_backup<((10^`p')*10)
		}
			replace `var'_round = `var'_round/(1000000000) if `var'_round>(1000000000)
			replace `var'_round_backup = `var'_round_backup/(1000000000) if `var'_round_backup>(1000000000)
