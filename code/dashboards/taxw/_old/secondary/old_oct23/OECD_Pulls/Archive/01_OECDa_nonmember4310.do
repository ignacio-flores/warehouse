...
sdmxuse data OECD, dataset(RS_GBL) dimensions(..4310.) attributes 
...
save "raw_data/eigt/intermediary_files/01_OECDa_nonmember4310.dta", replace


/*

// DISCARDED CODE FROM JOSH

replace powercode="1" if powercode=="0"
replace value=value*cond(powercode==1,1,1000000000)

drop if value==.

drop Tot_Rev_GDP Tot_Prop_Rev Fed_Rev_GDP Fed_Prop_Rev Loc_Rev_GDP Loc_Prop_Rev Reg_Rev_GDP Reg_Prop_Rev
