...
*The following two packages are required for this to work: moss and sdmxuse

*ssc install moss

*ssc install sdmxuse

*Furthermore, Stata's timeout may need to be tweaked for this to run.  It is a large datapull.

 set timeout1 180
 set timeout2 360


		import excel "D:/My Drive/PhD Stuff/Stone Center/JEM eigt_transcribed sample.xlsx", firstrow  clear
		...
		save "D:/My Drive/PhD Stuff/Stone Center/JEM eigt_transcribed sample.dta", replace
...
**# Bookmark #6
			...
			*/
			...
			save "D:/My Drive/PhD Stuff/Stone Center/eigt_transcribed.dta", replace
	...
	*** Only keep identifying info and error flags
	preserve
		...
		save "D:/My Drive/PhD Stuff/Stone Center/EIG_errors.dta", replace
...
*save "$dir/EIG Taxes/data_inputs/EIGtax_mergeable_wErrorFlags.dta"
	...
	*** Reset file to original for cleaning
	...
	save "D:/My Drive/PhD Stuff/Stone Center/eigt_fixed_errs.dta", replace 
