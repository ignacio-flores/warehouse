...
*-------------------------------------------------------------------------------------------------
reshape long v_, i(country Geo geo3 GeoReg year bracket) j(var) string

 drop if v_=="."

//export result
qui export delimited "EIGtax_long.csv", replace
