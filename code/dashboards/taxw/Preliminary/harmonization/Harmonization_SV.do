use "$sources/Final_Data/SV/appended_SV", clear
	...
	// Overlap between TIDD & EYa. We keep EYa for longer period  
...
// Last check: conflict in status by tax -- we can have conflict between everybody vs any other kinship (BUT NOT BETWEEN ANY OTHER COMBINATION e.g. children vs spouse) 
	...
	export excel using "$sources/Final_Data/SV/Final_SV.xlsx", firstrow(variables) sheet(Data) replace	
		erase "$sources/Final_Data/SV/appended_SV.dta"	
