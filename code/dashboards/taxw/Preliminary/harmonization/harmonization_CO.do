// Harmonization file for Colombia

	use "$sources/Final_Data/CO/appended_CO", clear
	...
	// Ovberlapping between TIDD and EYa for everybody estate in 2008. We keep EYa for consistency with following years 
		drop if year_from == "2008" & year_to == "2008" & tax == "estate" & applies_to == "everybody" & Source == "TIDData"
	...
	// Overlapping for gift and inheritance in 2008 between EY and TIDD. EY reports different tax, plus longer period coverage, drop TIDD. 
		drop if year_from == "2008" & year_to == "2008" & (tax == "inheritance" | tax == "gift") & Source == "TIDData"
...
// Last check: conflict in status by tax -- we can have conflict between everybody vs any other kinship (BUT NOT BETWEEN ANY OTHER COMBINATION e.g. children vs spouse) 
		...
		export excel using "$sources/Final_Data/CO/Final_CO.xlsx", firstrow(variables) sheet(Data) replace	
		erase "$sources/Final_Data/CO/appended_CO.dta"	
