use "$sources/Final_Data/RU/appended_RU", clear
	...
	// Conflicts between West and TIDD for 1882 for all kinship in inheritance and gift tax. TIDD reports wrong information misreading the original source (West 1909)! 
		drop if year_from == "1882" & year_to == "1882" & Source == "TIDData"
	...
	* No overlapping between children (or other) and everybody	
	...
	// Last possible overlapping: everybody and unknown
		...
		// Overlapping for gift and inheritance in 2006 between TIDD and EY. 
		drop if year_from == "2006" & year_to == "2006" & Source == "TIDData"
...
// Last check: conflict in status by tax -- we can have conflict between everybody vs any other kinship (BUT NOT BETWEEN ANY OTHER COMBINATION e.g. children vs spouse) 
		...
		export excel using "$sources/Final_Data/RU/Final_RU.xlsx", firstrow(variables) sheet(Data) replace	
		erase "$sources/Final_Data/RU/appended_RU.dta"	
