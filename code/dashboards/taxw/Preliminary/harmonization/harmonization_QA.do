use "$sources/Final_Data/QA/appended_QA", clear
		...
		replace year_to = "2005" if year_to == "2021" & Source =="TIDData"
...
// Last check: conflict in status by tax -- we can have conflict between everybody vs any other kinship (BUT NOT BETWEEN ANY OTHER COMBINATION e.g. children vs spouse) 
	...
	export excel using "$sources/Final_Data/QA/Final_QA.xlsx", firstrow(variables) sheet(Data) replace	
	erase "$sources/Final_Data/QA/appended_QA.dta"		
