use "$sources/Final_Data/TR/appended_TR", clear
	...
	* No overlapping between children (or other) and everybody	
	...
	// Conflict between EYa and EYb for 2011. We keep the EY2011b. 
	drop if year_from == "2011" & year_to == "2011" & inlist(tax, "inheritance", "gift") & Source == "EY2011a"
...
// Last check: conflict in status by tax -- we can have conflict between everybody vs any other kinship (BUT NOT BETWEEN ANY OTHER COMBINATION e.g. children vs spouse) 
	...
	export excel using "$sources/Final_Data/TR/Final_TR.xlsx", firstrow(variables) sheet(Data) replace
	erase "$sources/Final_Data/TR/appended_TR.dta"
