// Sources harmonization for Cuba

	use "$sources/Final_Data/CU/appended_CU", clear
		...
		// Overlapping between TIDD and Cuban tax law for inheritance in 2008. We keep the law
		drop if year_from == "2008" & year_to == "2008" & tax == "inheritance" & Source == "TIDData"
	...
	* No overlapping between children (or other) and everybody	
	...
	// Further possible overlapping: children and unknown: we keep children because the source is more specific
		...
		// Overlapping between TIDD and Law between 1994 and 2007. We keep the Law since 1994. 
		replace year_to = "1993" if year_to == "2007" & Source == "TIDData" & tax == "inheritance"
...
// Last check: conflict in status by tax -- we can have conflict between everybody vs any other kinship (BUT NOT BETWEEN ANY OTHER COMBINATION e.g. children vs spouse) 
	...
	export excel using "$sources/Final_Data/CU/Final_CU.xlsx", firstrow(variables) sheet(Data) replace
	erase "$sources/Final_Data/CU/appended_CU.dta"