	use "$sources/Final_Data/LT/appended_LT", clear
...
// Overlapping between EY and Lex 2006-2023 for all taxes. We drop EY.
...
// Last check: conflict in status by tax -- we can have conflict between everybody vs any other kinship (BUT NOT BETWEEN ANY OTHER COMBINATION e.g. children vs spouse) 
	...
	export excel using "$sources/Final_Data/LT/Final_LT.xlsx", firstrow(variables) sheet(Data) replace	
	erase "$sources/Final_Data/LT/appended_LT.dta"	
