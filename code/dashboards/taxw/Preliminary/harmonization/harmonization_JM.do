// Sources harmonization for Jamaica

	use "$sources/Final_Data/JM/appended_JM", clear
		...
		// Conflict between TID and EY for everybody-estate in 2008. We keep Ey. 
		drop if year_from == "2008" & year_to == "2008" & Source == "TIDData"
...
// Last check: conflict in status by tax -- we can have conflict between everybody vs any other kinship (BUT NOT BETWEEN ANY OTHER COMBINATION e.g. children vs spouse) 
	...
	export excel using "$sources/Final_Data/JM/Final_JM.xlsx", firstrow(variables) sheet(Data) replace	
	erase "$sources/Final_Data/JM/appended_JM.dta"	
