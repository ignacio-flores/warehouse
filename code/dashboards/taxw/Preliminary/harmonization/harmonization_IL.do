use "$sources/Final_Data/IL/appended_IL", clear
	...
	* No overlapping between children (or other) and everybody	
	...
	// Last possible overlapping: everybody and unknown
		...
		// Overlapping TIDD and EY for estate. We stop TID at 2005. 
		replace year_to = "2005" if year_to == "2021" & Source == "TIDData" & tax == "estate"
...
// Last check: conflict in status by tax -- we can have conflict between everybody vs any other kinship (BUT NOT BETWEEN ANY OTHER COMBINATION e.g. children vs spouse) 
	...
	export excel using "$sources/Final_Data/IL/Final_IL.xlsx", firstrow(variables) sheet(Data) replace	
	erase "$sources/Final_Data/IL/appended_IL.dta"	
