use "$sources/Final_Data/TT/appended_TT", clear
...
// Last check: conflict in status by tax -- we can have conflict between everybody vs any other kinship (BUT NOT BETWEEN ANY OTHER COMBINATION e.g. children vs spouse) 
		...
		export excel using "$sources/Final_Data/TT/Final_TT.xlsx", firstrow(variables) sheet(Data) replace	
		erase "$sources/Final_Data/TT/appended_TT.dta"	
