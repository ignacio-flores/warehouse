 use "$sources/Final_Data/MX/appended_MX", clear
	...
	// Overlapping between TIDD and EYa for estate and inheritance taxes (everybody) over 2006-2008. We keep EYa as it covers more year after. 
		
		replace year_to = "2005" if year_to == "2008" & Source == "TIDData"
...
// Last check: conflict in status by tax -- we can have conflict between everybody vs any other kinship (BUT NOT BETWEEN ANY OTHER COMBINATION e.g. children vs spouse) 
		...
		export excel using "$sources/Final_Data/MX/Final_MX.xlsx", firstrow(variables) sheet(Data) replace	
		erase "$sources/Final_Data/MX/appended_MX.dta"	
