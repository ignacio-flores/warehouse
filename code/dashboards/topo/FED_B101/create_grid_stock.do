...
** Set paths here
global path "${topo_dir_raw}/FED_B101/auxiliary files"
global origin "${topo_dir_raw}/FED_B101/raw data"


* Import dates
import delimited "${origin}/b101.csv", delimiter(comma) varnames(1) clear 
...
gen XDHHCE = .
label var XDHHCE "Consumer durables"
...
gen XAF42LM = .
label var XAF42LM "Long term loans secured by mortgage"

gen B90 = .
label var B90 "Net worth"	

gen BF90 = .
label var BF90 "Financial net worth"	

* Recast all variables as double 
foreach var of varlist AN- BF90{
   recast double `var'
}
