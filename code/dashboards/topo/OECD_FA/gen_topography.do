...
global bycountry "${topo_dir_raw}/OECD_FA/intermediate/grid"
global bycountry_data "${topo_dir_raw}/OECD_FA/intermediate"
global cmappings "${topo_dir_raw}/OECD_FA/auxiliary files"
global intermediate "${topo_dir_raw}/OECD_FA/intermediate to erase"
global output "${topo_dir_raw}/OECD_FA/final table"
...
global output "${topo_dir_raw}/OECD_FA/final table"
save "${output}/OECD_FA_warehouse.dta", replace
export delimited using "${output}/OECD_FA_warehouse.csv", replace
